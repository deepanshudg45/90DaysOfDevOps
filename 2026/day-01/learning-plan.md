# 90-Day Cloud & DevOps Learning Plan

## Current Level

I am a **B.Tech Computer Science and Engineering fresher** with hands-on knowledge of:
...
Cloud is about **creating, managing, and scaling infrastructure** so applications run smoothly without failures. It focuses on:
...
The goal is to ensure applications stay reliable even when things break, because things *will* break.

### DevOps

DevOps is not just a collection of tools.

It is a **mindset** that bridges the gap between development and operations to deliver applications smoothly and reliably to end users. Introduced around 2009 by Patrick Debois, DevOps focuses on:
...
In the next 90 days, I want to be **confident, not just familiar** with DevOps.

That means:
- Deploying real applications end to end  
- Creating infrastructure instead of clicking around the console  
- Automating workflows  
- Debugging failures in real systems  
...
1. **Deploy a production-style web application on AWS**  
   Using Docker, CI/CD pipelines, and Kubernetes.

2. **Build infrastructure using Terraform**  
   Including EC2, VPC, and EKS basics — understanding how real infrastructure and pipelines are designed for different scenarios.
...
1. **Linux & Cloud Troubleshooting**  
   Debugging logs, networking issues, permissions, and service failures.

2. **CI/CD Pipelines**  
   Automating build, test, and deployment using modern CI/CD tools.
...
- Focus on **doing**, not hoarding tutorials  
